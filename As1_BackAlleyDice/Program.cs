...
namespace As1_BackAlleyDice
{
    internal class Program
    {
        ...
        { 
            ...
            //Display or skip intro
            while (true)
            {
                printTxt("Skip intro?: Y/N");
                string skipIntro = Console.ReadLine();
                skipIntro = skipIntro.ToUpper();
                ...
                {
                    printTxt("Please, enter a valid answer");
                    continue;
                }
            ...
            while (playerContinue) 
            {
                ...
                if (!int.TryParse(typeOfBetInput, out typeOfBet))
                {
                    printTxt("C'mon man! I told you JUST NUMBERS. Do you want to upset me? Please just enter a valid number:");
                    continue;
                }
                ...
                if (!int.TryParse(typeOfBetInput, out sizeOfBet))
                {
                    printTxt("C'mon man! I told you JUST NUMBERS. Do you want to upset me? Please just enter a valid number:");
                    continue;
                }
